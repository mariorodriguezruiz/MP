...
class Lista{
    ...
    private:
        ...
        *
        * Construye una lista a partir del contenido de @a otra
        */
        void copiaDatos(const Lista &otra) ;
    public:
        ...
        */
        ...
        /**
        * @brief Construye una lista a partir de otra
        * @param lista es el objeto a copiar
        *
        * Construye una lista a partir de un objeto @a cadena
        */
        ...
        * @param lista es el objeto a copiar
        *
        * Sobrecarga el operador ’+’ para poder realizar operaciones de concatenación de listas
        */
