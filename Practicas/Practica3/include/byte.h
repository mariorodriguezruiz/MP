...
const int NUM_POS = 7 ; ///< Un @c NUM_POS contiene el tamaño de la secuencia de bitS
...
/**
@brief comprueba que una posición se encuentra en el rango de la máscara.
@param pos 	el bit dentro de un bloque
*/
bool esCorrectaLaPosicion(const int pos) ;

/**
@brief muestra por pantalla el bloque de led completo.
@param b el @c byte que se quiere consultar
*/
